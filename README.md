![Close to Work](https://img.shields.io/badge/Open%20to%20Work-brightred?style=for-the-badge)

Здравствуйте! 👋

**Middle+ C# Unity разработчик** с опытом более 4 лет. Участвовал в полном цикле разработки и выпустил более 15 успешных мобильных проектов (iOS/Android). Работал в продуктовых компаниях и стартапах, выстраивал модульную архитектуру, оптимизировал производительность и автоматизировал рутину.
